...
class PHPMailer
{
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img src="/assets/img/a.png"> and must not be empty
     * will look for an image file in $basedir/assets/img/a.png and convert it to inline.
