    ...
    if ($action === 'add' || $action === 'edit') {
        ...
        if (!empty($_FILES['product_image']['name']) && $_FILES['product_image']['error'] === 0) {
            ...
            if (in_array($_FILES['product_image']['type'], $allowed)) {
                ...
                $imageName = 'assets/uploads/products/' . $imageName;
            }
        }
            ...
            <form method="POST" enctype="multipart/form-data" class="space-y-3">
                ...
                <div>
                    ...
                    <div class="mb-2 flex items-center gap-3">
                        <img src="<?= SITE_URL ?>/assets/img/<?= $editProduct['image'] ?>" alt="Current" class="w-16 h-16 rounded-lg object-cover border border-gray-200" onerror="this.src='<?= SITE_URL ?>/<?= $editProduct['image'] ?>'">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-3">
                                    <img src="<?= SITE_URL ?>/assets/img/<?= $p['image'] ?>" alt="" class="w-10 h-10 rounded-lg object-cover border border-gray-100" onerror="this.src='<?= SITE_URL ?>/<?= $p['image'] ?>'">
                                    <div>
