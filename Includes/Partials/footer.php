            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="<?= SITE_URL ?>/booking/services.php" class="text-sm text-gray-400 hover:text-white hover:translate-x-1 transition-all inline-block">Book Appointment</a></li>
                    </ul>
                </div>
